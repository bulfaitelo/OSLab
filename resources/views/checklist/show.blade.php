    ...
    <div class="col-md-12">
        ...
        <div class="card">
            <div class="card-header">
              ...
              <a href="{{ route('relatorio.sistema.auditoria.index', ['auditable_type' => get_class($checklist), 'auditable_id' => $checklist->id]) }}">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            {!! html()->select('categoria_id', \App\Models\Configuracao\Parametro\Categoria::orderBy('name')->pluck('name', 'id'), $checklist->categoria_id)->class('form-control')->placeholder('Selecione')->disabled() !!}
                        </div>
                    </div>
                </div>
            </div>
