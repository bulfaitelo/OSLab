<div class="content ">
    ...
    <table class=" mt-2 mb-2 ">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="pt-0 pb-0 pl-1  ">
                    {{ $os->cliente->telefone }}@if (($os->cliente->telefone != "") && ($os->cliente->celular != "")),
                    @endif {{ $os->cliente->celular }}
                </td>
            ...
            <tbody>
                ...
                @foreach ($os->servicos as $item)
                    <tr>
                        ...
                        <td class="pt-0 pb-0 pr-1 text-right"> R$ {{ number_format($item->valor_servico_total, 2, ",", ".") }}
                        </td>
                    </tr>
                @endforeach
            </tbody>
    ...
    <table class=" radius mt-2 mb-2">
        <thead>
            ...
            <tr>
                <th class="pt-0 pr-1 pb-0 header text-right"><b>VALOR TOTAL DA OS:
                        {{ number_format($os->valorTotal(), 2, ",", ".") }}</b></th>
            </tr>
        </thead>
