                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="form-group mb-2 ">
                            ...
                            {!! html()->select('categoria_id', \App\Models\Configuracao\Os\CategoriaOs::orderBy('name')->pluck('name', 'id'), $request->categoria_id)->class('form-control form-control-sm')->placeholder('Selecione') !!}
                        </div>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="form-group mb-2 ">
                            ...
                            {!! html()->select('status_id', \App\Models\Configuracao\Os\StatusOs::orderBy('name')->pluck('name', 'id'), $request->status_id)->class('form-control form-control-sm')->placeholder('Selecione') !!}
                        </div>
                    </div>
