                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                {!! html()->select('cliente_id')->class('form-control cliente')->placeholder('Selecione')->required()->disabled($receita->os_id) !!}
                            </div>
                        </div>
                    </div>
                    <div class="row">
                            ...
                            <td>
                                <div class="btn-group btn-group-sm">
                                    @can('financeiro_receita_pagamento_edit')
                                        <button  title="Editar" class="btn btn-left btn-info" data-toggle="modal" data-json="{{$item->dataModal()}}"  data-url="{{route('financeiro.receita.pagamento.update', [$receita->id, $item->id])}}" data-target="#modal-editar" ><i class="fas fa-edit"></i></button>
                                    @endcan
                                    @can('financeiro_receita_pagamento_destroy')
                                        <button type="button" class="btn btn-block btn-danger" data-toggle="modal" data-name="{{$item->parcela}}" data-url="{{route('financeiro.receita.pagamento.destroy', [$receita->id, $item->id])}}" data-target="#modal-excluir"><i class="fas fa-trash"></i></button>
                                    @endcan
                                </div>
                            </td>
                        </tr>
