...
@section('title', 'Criar Forma de Pagamento')

@section('content_header')
    <h1><i class="fa-solid fa-money-bill-transfer "></i> Criar Forma de Pagamento</h1>
@stop
    ...
    <div class="col-md-9 ">
        ...
        <div class="card">
          ...
          <div class="card-body">
            ...
            {!! html()->form('post', route('configuracao.financeiro.forma_pagamento.store'))->open() !!}
