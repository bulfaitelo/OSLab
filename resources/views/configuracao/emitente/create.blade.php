            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="img-container">
                        ...
                        <img id="logo_emitente" src="{{ asset('vendor/oslab/imgs/oslab_logo.svg') }}" alt="Logo da empresa" class="rounded image img-fluid">
                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <div class="form-group">
                                ...
                                {!! html()->text('site_url')->class('form-control')->placeholder('Site, exemplo: http://www.oslab.com.br') !!}
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
