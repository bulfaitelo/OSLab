...
@section('content_header')
    <h1><i class="fas fa-wave-square "></i> Visualizar Status</h1>
@stop
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    <label>Cor</label>
                    <br>
                    <div class="{{$status->color}}" style="width: 70px;height: 32px;border-radius: 3px;" ></div>
                </div>
                <div class="row mb-2">
                    <div class="col-md-12">
                        <label for="garantia">
                        ...
                        <div class="custom-control custom-switch custom-switch-md">
                            {!! html()->checkbox('garantia', $status->garantia)->class('custom-control-input')->disabled() !!}
