    ...
    <div class="col-md-10 ">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                {!! html()->form('PUT', route('configuracao.parametro.status.update', $status->id))->open() !!}
                <div class="row">
                    <div class="col-md-10">
                    ...
                    <div class="col-md-1">
                        ...
                        <div class="custom-control custom-switch custom-switch-md">
                            {!! html()->checkbox('os', $status->os)->class('custom-control-input') !!}
                    ...
                    <div class="col-md-1">
                        ...
                        <div class="custom-control custom-switch custom-switch-md">
                            {!! html()->checkbox('venda', $status->venda)->class('custom-control-input') !!}
