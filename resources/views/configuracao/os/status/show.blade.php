        ...
        <div class="card">
          ...
          <div class="card-body">
            <div class="form-group">
              ...
              {!! Form::text('name', $status->name, ['id' => 'name', 'class' => 'form-control', 'placeholder' => 'Status', 'required', 'disabled' ]) !!}
            </div>
            <div class="form-group">
                <label for="descricao">Descrição</label>
                {!! Form::text('descricao', $status->descricao, ['id' => 'descricao', 'class' => 'form-control', 'placeholder' => 'Descrição', 'disabled' ]) !!}
            </div>
            <div class="form-group">
                <label>Cor</label>
                <br>
                    ...
                    <label for="{{$cor}}">
                        <span class="right badge {{$cor}}">
                            <input @if ($cor == $status->color)
                                checked
                            @endif type="radio" @disabled(true) name="color" style='margin:4px' value="{{$cor}}" id="{{$cor}}">
                        </span>
                    </label>
                </div>
            @endforeach
            ...
            <div class="row">
                <div class="col-md-2">
                    ...
                    <div class="custom-control custom-switch">
                        {!! Form::checkbox('ativar_email', true, $status->ativar_email, ['id'=> 'ativar_email', 'class' => 'custom-control-input', 'disabled' ]) !!}
                ...
                <div class="col-md-4">
                    ...
                    <div class="input-group">
                        {!! Form::text('prazo_email', $status->prazo_email, ['id' => 'prazo_email', 'class' => 'form-control', 'placeholder' => 'Prazo D + X', 'disabled' ]) !!}
            ...
            <div class="row">
                <div class="col-md-2">
                    ...
                    <div class="custom-control custom-switch">
                        {!! Form::checkbox('ativar_rastreio', true, $status->ativar_rastreio, ['id'=> 'ativar_rastreio', 'class' => 'custom-control-input', 'disabled' ]) !!}
