...
<div class="row justify-content-md-center">
    <div class="col-md-10 ">
        ...
        <div class="card">
          ...
          {!! Form::open(['route' => ['configuracao.os.garantia.store']]) !!}
          <div class="row">
            <div class="col-md-9">
                <div class="form-group">
                  <label for="name">Nome da Garantia</label>
                  {!! Form::text('name', '', ['id' => 'name', 'class' => 'form-control', 'placeholder' => 'Nome da Garantia']) !!}
                </div>
            </div>
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    <div class="input-group mb-3">
                        {!! Form::text('prazo_garantia', '', ['id' => 'prazo_garantia', 'class' => 'form-control code', 'placeholder' => 'Prazo de garantia']) !!}
            ...
            <div class="form-group">
                ...
                {!! Form::textarea('garantia', '', ['id' => 'garantia', 'class' => 'form-control', 'placeholder' => 'Descrição do centro de custo']) !!}
            </div>
