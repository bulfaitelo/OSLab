...
@section('content_header')
    <h1><i class="fas fa-hand-holding-usd "></i> Visualizar Serviço</h1>
@stop
    ...
    <div class="col-md-9 ">
        ...
        <div class="card">
            <div class="card-header">
              ...
              <a href="{{ route('relatorio.sistema.auditoria.index', ['auditable_type' => get_class($servico), 'auditable_id' => $servico->id]) }}">
