        ...
        <div class="row">
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    {!! html()->select('status_id', \App\Models\Configuracao\Parametro\Status::orderBy('name')->pluck('name', 'id'), $os->status_id)->class('form-control')->placeholder('Selecione')->required() !!}
                </div>
            </div>
            <div class="col-md-2">
                <div class="form-group">
