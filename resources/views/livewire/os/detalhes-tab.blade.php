        ...
        <div class="row">
            ...
            <div class="col-md-2">
                <div class="form-group">
                    ...
                    {!! html()->select('categoria_id', \App\Models\Configuracao\Parametro\Categoria::orderBy('name')->pluck('name', 'id'), $os->categoria_id )->class('form-control')->placeholder('Selecione') !!}
                </div>
            </div>
            <div class="col-md-2">
                <div class="form-group">
        ...
        <div class="row">
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    {!! html()->select('status_id', \App\Models\Configuracao\Parametro\Status::where('os', 1)->orderBy('name')->pluck('name', 'id'), $os->status_id)->class('form-control')->placeholder('Selecione')->required() !!}
                </div>
            </div>
            <div class="col-md-2">
                <div class="form-group">
