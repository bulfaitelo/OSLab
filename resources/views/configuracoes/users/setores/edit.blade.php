        ...
        @endif                  
          {!! Form::open(['route' => ['configuracoes.user.setor.update', $setor->id],'method' => 'put']) !!}
            ...
            <div class="form-group">
              ...
              {!! Form::select('departamento_id', \App\Models\Configuracao\User\Departamento::orderBy('departamento')->pluck('departamento', 'id'), $setor->departamento_id ?? '', ['id' => 'group','class' => 'form-control' ]) !!}                   
            </div>            
          </div>          
