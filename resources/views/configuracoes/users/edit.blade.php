...
<div class="row justify-content-md-center">
    <div class="col-md-10 ">
        ...
        @endif
          ...
          {!! Form::open(['route' => ['configuracoes.users.update', $user->id],'method' => 'put']) !!}
            <div class="form-group">
              <label for="name">Usuário</label>
              {!! Form::text('name', $user->name, ['id' => 'name', 'class' => 'form-control', 'placeholder' => 'nome_permissao']) !!}
            </div>
            <div class="form-group">
              <label for="email">Email</label>
              {!! Form::text('email', $user->email, ['id' => 'description','class' => 'form-control', 'placeholder' => 'nome_permissao', 'disabled']) !!}
            </div>
            <div class="form-group">
              <label for="setor">Setor</label>
              {!! Form::select('setor', \App\Models\Configuracao\User\Setor::orderBy('name')->pluck('name', 'id'), $user->setor_id, ['id' => 'group','class' => 'form-control' ]) !!}
            </div>
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
